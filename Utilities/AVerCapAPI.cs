...
namespace AverMediaLib
{
    ...
    public class AvermediaDeviceInfo
    {
        public int DeviceNumber { get; set; }
        public string DeviceName { get; set; }
        public string DeviceType { get; set; }

        public AvermediaDeviceInfo(int deviceNumber, string deviceName, string deviceType)
        {
    ...
    public enum RCMODE
    {
        RCMODE_CBR = 0x01, //¹Ì¶¨ÂëÂÊÄ£Ê½
        RCMODE_VBR = 0x02, //¿É±äÂëÂÊÄ£Ê½
        RCMODE_ABR = 0x03, //Æ½¾ùÂëÂÊÄ£Ê½
        RCMODE_STRICT_ABR = 0x04,//ÑÏ¸ñÆ½¾ùÂëÂÊÄ£Ê½
    }
    ...
    [StructLayout(LayoutKind.Sequential)]
    public struct VIDEO_COLOR_ADJUSTMENT
    {
        public uint dwVersion;//must set to 1
        public uint dwMode;
        public uint dwProperty;
        public uint dwPropertyValue;//[0~255] Default:127
    }

    public enum COLOR_ADJUSTMENT_MODE
    {
        MODE_HW = 0,
        MODE_SW = 1
    };
    ...
    static class AVerCapAPI
    {
        ...
        // Overlay
        [DllImport("AVerCapAPI.dll")]
        public static extern int AVerOverlayImage(IntPtr hCaptureObject, ref OVERLAY_IMAGE_INFO ImageInfo, uint dwDuration);
        [DllImport("AVerCapAPI.dll")]
        ...
        // Color Adjustment
        [DllImport("AVerCapAPI.dll", CharSet = CharSet.Unicode)]
        public static extern int AVerGetVideoColorAdjustment(IntPtr hCaptureObject, ref VIDEO_COLOR_ADJUSTMENT pVideoColorAdjustment);
        [DllImport("AVerCapAPI.dll", CharSet = CharSet.Unicode)]
        public static extern int AVerSetVideoColorAdjustment(IntPtr hCaptureObject, ref VIDEO_COLOR_ADJUSTMENT pVideoColorAdjustment);
